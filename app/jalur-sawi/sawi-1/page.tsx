    ...
    return (
        <main className='relative min-h-screen bg-[#f9f295] overflow-hidden'>
            ...
            <div className='relative z-10 p-6 md:hidden flex flex-col min-h-screen gap-6'>
                {/* Card Teks Cerita */}
                <div className='bg-white/80 backdrop-blur-sm p-6 rounded-3xl shadow-xl border border-white/20 mt-4'>
                ...
                {/* Card Foto & Konteks */}
                <div className='bg-white/90 backdrop-blur-sm p-4 rounded-3xl shadow-xl border border-white/30'>
                ...
                <div className='bg-white/80 backdrop-blur-sm p-6 rounded-3xl shadow-xl border border-white/20'>
                    <div className='space-y-4 text-lg text-gray-800 leading-relaxed font-medium text-justify'>
                        ...
                        <p className='pt-4 border-t border-black/5 text-gray-600 italic'>
