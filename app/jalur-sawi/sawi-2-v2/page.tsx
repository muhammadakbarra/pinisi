        ...
        <main className='relative min-h-screen bg-[#f9f295] overflow-hidden'>
            ...
            <div className='relative z-10 p-6 md:hidden flex flex-col min-h-screen gap-10 overflow-y-auto'>
                ...
                >
                    ...
                    <p>
                        Dan, dalam beribu-ribu halaman naskah La Galigo <Link href="https://www.scribd.com/doc/263321885/Berlayar-ke-Tompotikka-Suatu-Episode-La-Galigo" target="_blank" className="text-blue-700 underline decoration-2">tidak sesekali pun</Link> muncul kata ‘pinisi’ – ada banyak jenis perahu, tetapi ‘pinisi’ tidak ada. Bahkan sudah pernah ada penawaran hadiah 10 juta Rupiah bagi yang bisa menunjukkan ‘pinisi’ dalam naskah-naskah La Galigo, tetapi sampai hari ini belum ada yang berani mengklaim uangnya.
                    </p>
                </motion.div>

                {/* Foto Potongan Berita Tanpa Card */}
                <motion.div 
                    initial="hidden"
                    whileInView="visible"
                    viewport={{ once: true, margin: "-50px" }}
                    variants={fadeInVariants}
                >
                    <div className='relative w-full aspect-[2.5/1] rounded-2xl overflow-hidden shadow-xl'>
                        <Image 
                            src='/sawi/sawi-2.png'
                ...
                {/* Teks Tantangan 10 Juta Tanpa Card */}
                <motion.div 
                    initial="hidden"
                    whileInView="visible"
                    viewport={{ once: true, margin: "-50px" }}
                    variants={fadeInVariants}
                    className='text-lg text-gray-900 leading-relaxed font-black text-justify text-pretty'
                >
                    <p>
                        … Bestie pun boleh coba: Ini ada <Link href="https://digitalcollections.universiteitleiden.nl/view/item/29355#page/1/mode/1up" target="_blank" className="text-blue-700 underline decoration-2">tautan</Link> ke naskah epos La Galigo paling lengkap yang ada. Kalau dapat, ya langsung hubungi kami, dan kami bayarkan 10 juta itu!
                    </p>
                </motion.div>
                ...
                >
                    <Link href="/jalur-sawi/sawi-1-v2" className='bg-white/90 px-6 py-3 rounded-2xl shadow-md text-gray-900 font-bold active:scale-95 transition-transform border border-black/5'>
                        ← Kembali
                    </Link>
                    <Link href="/jalur-sawi/sawi-2-1-v2" className='bg-[#f8c24a] px-6 py-3 rounded-2xl shadow-md text-gray-900 font-bold active:scale-95 transition-transform border border-black/5'>
                        Lanjut →
                    </Link>
                </motion.div>
            </div>
